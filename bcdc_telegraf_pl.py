...
# Called few times a day (plus in startup) from Telegraf, results are resent to Arska Server and InfluDb
...
bcdcLocationsHandled = arska_settings["bcdcLocationsHandled"]
